...
def main():
    ...
    parser_format.add_argument("-r", action="store_true", help="execute recursively, if a directory is passed")
    ...
    parser_stats.add_argument("-r", action="store_true", help="execute recursively, if a directory is passed")
